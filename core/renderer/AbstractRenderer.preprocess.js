...
AbstractRenderer.prototype = {
      ...
      if ( typeof type !== 'undefined' && type !== constants.get( 'VALUE' ) ) {                           \
        ...
        if ( type === constants.get( 'PERCENT' ) ) {                                                      \
          ...
          throw Error( 'Got unknown `value` type. The known are: VALUE, PERCENT, CONSTANT' );             \
                                                                                                          ...
                                                                                                          \
      this._##backgroundPositionX = value;                                                                \
      return this;                                                                                        \
    }
   ...
   */
  rectAlignX( rectAlignX, LEFT, CENTER, RIGHT ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len
   ...
   */
  rectAlignX( rectAlignY, TOP, MIDDLE, BOTTOM ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len
   ...
   */
  fill( stroke, _doStroke ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len
   ...
   */
  fill( fill, _doFill ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len

  #define noFill( noFill, _doFill ) \
   ...
   * renderer.noStroke();
   */
  noFill( noStroke, _doStroke ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len
   ...
   * renderer.noFill();
   */
  noFill( noFill, _doFill ), // eslint-disable-line brace-rules/brace-on-same-line, no-useless-concat, quotes, max-statements-per-line, max-len
