...
describe( "internal/align", function () {
  ...
  describe( 'align()', function () {
    it( 'works', function () {
      align( 500, 250, constants.get( 'LEFT' ) ).should.equal( 500 );
      align( 400, 200, constants.get( 'MIDDLE' ) ).should.equal( 300 );
      align( 300, 150, constants.get( 'BOTTOM' ) ).should.equal( 150 );
    } );
  } );
